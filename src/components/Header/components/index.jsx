...
const Header = () => {
  return (
    <header className="shadow-md fixed top-0 left-0 w-full z-50 " style={{backgroundColor:"var(--color-primary)"}} >
      <div className="">
        <Sidebar/>
      </div>
      <div className="fixed top-0 left-10 w-full z-50 bg-transparent bg-opacity-30 backdrop-blur-md shadow-md">
        <div className="container mx-auto px-12 py-4 bg-tran flex justify-between items-center opacity-100">
          <div className=""></div>
